<script setup lang="ts">
    import ColorModeButton from '../ui/ColorModeButton.vue';
    import LogoWeb from '../icons/LogoWeb.vue';
</script>


<template>
    <nav class="h-full w-[95%] relative overflow-hidden mx-auto grid grid-cols-3">
