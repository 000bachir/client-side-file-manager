...
<template>
    <main class="h-auto w-full relative overflow-hidden ">
        <section class="h-dvh w-[95%] relative mx-auto grid grid-cols-2">
            <article
            ...
            <article class="col-span-1 h-full flex items-center justify-center bg-amber-400"></article>
        </section>
    </main>
</template>